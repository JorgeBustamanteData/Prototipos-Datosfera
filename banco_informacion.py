...
try:
    # Asegurarse de que el archivo CSV correspondiente exista
    archivo_csv = f'{sector_seleccionado}.csv'
    if os.path.exists(archivo_csv):
        ...
        st.error(f"El archivo para el sector '{sector_seleccionado}' no fue encontrado. Asegúrate de que el archivo '{archivo_csv}' esté en la carpeta correcta.")
